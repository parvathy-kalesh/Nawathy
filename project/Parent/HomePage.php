  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light p-0">
        <a class="navbar-brand" href="HomePage.php"><img src="../assets/Template/Main/images/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@courses">
              <a class="nav-link" href="ViewBooking.php">Booking</a>
            </li>
...
<body  background-image: url('../assets/Template/Main/images/bg.png');
      background-size: cover;
      background-attachment: fixed;>
<h1 align="center" style="margin-top:150px;">WELCOME ::<?php echo $_SESSION['parent_name']?> 
<!-- <a href="MyProfile.php">Myprofile</a>
<br><a href="Editprofile.php">editprofile</a><br>
