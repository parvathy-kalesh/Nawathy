  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light p-0">
        <a class="navbar-brand" href="index.html"><img src="assets/Template/Main/images/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@about">
              <a class="nav-link" href="Guest/parentreg.php">Parent SignUp</a>
            </li>
            <li class="nav-item @@courses">
              <a class="nav-link" href="Guest/tutorreg.php">Tutor SignUp</a>
            </li>
...
<!-- hero slider -->
<section class="hero-section overlay bg-cover" data-background="assets/Template/Main/images/banner/banner-2.png">
  <div class="container">
      ...
      <div class="hero-slider-item">
        <div class="row">
          <div class="col-md-8">
            ...
            <p class="text-muted mb-4" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".4">education is important</p>
            <a href="Guest/Login.php" class="btn btn-primary" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".7">LogIn</a>
          </div>
        </div>
      </div>
      <!-- slider item -->
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <p class="text-muted mb-4" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
              ...
              dxolore magna aliqua. Ut enim ad minim veniam, quis nostrud exer</p>
            <a href="Guest/Login.php" class="btn btn-primary" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".7">Login</a>
          </div>
        </div>
      </div>
      <!-- slider item -->
      <div class="hero-slider-item">
        <div class="row">
          <div class="col-md-8">
            ...
            <a href="Guest/Login.php" class="btn btn-primary" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="zoomIn" data-delay-in=".7">Login</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid p-0">
    <div class="row no-gutters">
      <div class="col-xl-4 col-lg-5 align-self-end">
        <img class="img-fluid w-100" src="assets/Template/Main/images/banner/banner-feature.jpg" alt="banner-feature">
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
        <img class="img-fluid w-100" src="assets/Template/Main/images/about/about-us-2.jpg" alt="about image">
      </div>
    </div>
  </div>
</section>
...
<!-- success story -->
<section class="section bg-cover" data-background="assets/Template/Main/images/backgrounds/success-story.jpg">
  <div class="container">
    <div class="row">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="assets/Template/Main/images/teachers/tchr.jpg" alt="teacher">
          <div class="card-body">
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="assets/Template/Main/images/teachers/teacher-2.jpg" alt="teacher">
          <div class="card-body">
            <a href="teacher-single.html">
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="assets/Template/Main/images/teachers/teacher-3.jpg" alt="teacher">
          <div class="card-body">
            <a href="teacher-single.html">
