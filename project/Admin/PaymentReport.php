...
<html lang="en" >
    ...
    <body>
        ...
        <form method="post" class="form-inline justify-content-center">
            ...
            <button type="submit" class="btn btn-primary" name="btn_search">Search align</button>
        </form>
        <br><br><br>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_paymentrecords p inner join tbl_tutor t on t.tutor_id=p.tutor_id ";
			 
			 
			 
			 if(isset($_POST["btn_search"]))
			 {
				 $selQry = $selQry." and payment_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
			 }
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["payment_date"]; ?></td>
                 <td align="center"><?php echo $data["tutor_name"]; ?></td>
                 <td align="center"><?php if ($data["t_status"]==1)
                 {
                    echo "Accpted";

                 }
                 else if ($data["t_status"]==2)
                 {
                    echo "Rejected";
